%% 右边点（中间三个点）
function C=C_rightcolumn(LG,P,C,Q,row,N,dim)
...
%         plot_fig(LG,N,dim);
        fprintf('error_rightcolumn_111\n');
    end
else
%     plot_fig(LG,N,dim);
    fprintf('error_rightcolumn\n');
end
